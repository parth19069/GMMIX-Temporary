...
if args.dataset == "nft":
    trainset = NFTDataset(folder_path = '/home/data/nft_data/half_tweet_data', image_folder_path='/home/data/nft_data',image_lookback=5, tweet_lookback=5, transform=preprocess).filter_df("train")
    testset = NFTDataset(folder_path = '/home/data/nft_data/half_tweet_data', image_folder_path='/home/data/nft_data',image_lookback=5, tweet_lookback=5, transform=preprocess).filter_df("test")
    # validset = 
